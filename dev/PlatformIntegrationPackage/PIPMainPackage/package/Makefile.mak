...
TARGET_BASENAME=PIPMain.Msix

TARGET_EXE=CentennialMainExe
TARGET_EXE_DIR=$(OutDir)$(TARGET_EXE)
TARGET_EXE_FILE=$(TARGET_EXE_DIR)\$(TARGET_EXE).exe

TARGET_PROXYSTUB=Main.Sidecar.LifetimeManager.ProxyStub
...
$(OutMsix): $(ProjectDir)appxmanifest.xml
    ...
    @copy /Y $(ProjectDir)PIPAppxManifest.xml $(WorkDir)\PIPAppxManifest.xml
